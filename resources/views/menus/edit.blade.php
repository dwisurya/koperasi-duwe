            ...
            <form action="{{ route('admin.menus.update', $menu) }}" method="POST">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="icon" value="{{ old('icon', $menu->icon) }}" class="form-control">
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">Route Name</label>
                        <input type="text" name="route" value="{{ old('route', $menu->route) }}" class="form-control">
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="permission" value="{{ old('permission', $menu->permission) }}" class="form-control">
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">Order</label>
                        <input type="number" name="order" value="{{ old('order', $menu->order) }}" min="0" class="form-control">
                    </div>
                    <div class="col-md-6 d-flex align-items-center">
                        <div class="form-check mt-4">
                            <input type="checkbox" name="is_active" value="1" class="form-check-input" id="is_active" {{ $menu->is_active ? 'checked' : '' }}>
